    ...
    <main style="min-height: 100vh; max-width: 100%;">
        ...
        <div style="margin: 20px 13%;">
            ...
            if(isset($_POST['btn'])) {
                ...
                $sql = "INSERT INTO `cau_hoi` (`ten_cau_hoi`, `dap_an`, `correct`,`loai_cau_hoi`, `anh_cau_hoi`, `id_user_them`, `id_khoa_hoc`, `status`) VALUES ('$question' ,'$da', '$arr', 'Chọn 1','', '$id_user', '$id',$stt)";
